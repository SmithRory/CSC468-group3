...
class DebugType(mongoengine.EmbeddedDocument):
    ...
    def log(self, transactionNum, command, timestamp=round(time.time()*1000), username=None, stockSymbol=None, filename=None, funds=None, debugMessage=None):
        # Get all the logs.
...
class ErrorEventType(mongoengine.EmbeddedDocument):
    ...
    def log(self, transactionNum, command, timestamp=round(time.time()*1000), username=None, stockSymbol=None, filename=None, funds=None, errorMessage=None):
        # Get all the logs.
        logs = LogType.objects.first()
        # Create the new log.
...
class SystemEventType(mongoengine.EmbeddedDocument):
    ...
    def log(self, transactionNum, command, timestamp=round(time.time()*1000), username=None, stockSymbol=None, filename=None, funds=None):
        # Get all the logs.
        logs = LogType.objects.first()
        # Create the new log.
...
class AccountTransactionType(mongoengine.EmbeddedDocument):
    ...
    def log(self, transactionNum, action, username, funds, timestamp=round(time.time()*1000)):
        # Get all the logs.
        logs = LogType.objects.first()
        # Create the new log.
...
class QuoteServerType(mongoengine.EmbeddedDocument):
    ...
    def log(self, transactionNum, price, stockSymbol, username, quoteServerTime, cryptokey, timestamp=round(time.time()*1000)):
        # Get all the logs.
        logs = LogType.objects.first()
        # Create the new log.
